            ...
            <div class="col-10">
                ...
                <!-- <div class="container mt-5">
                        ...
                        <tbody>
                            <tr th:each="paket, stat : ${pakets}">
                                ...
                                <td>
                                    ...
                                    <form th:action="@{/paket-mcu/delete/{id}(id=${paket.id})}" method="post" style="display:inline;">
                    ...
                    <div class="container">
                        ...
                        <a href="{{ route('paket_mcu.create') }}" class="btn btn-primary mb-3">Tambah Paket MCU</a>
                        <table class="table">
                            <thead>
                                <tr>
                                    <th>#</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $paket->jenis_pemeriksaan }}</td>
                                    <td>{{ $paket->harga }}</td>
                                    <td>
                                        <a href="{{ route('paket_mcu.edit', $paket->id) }}" class="btn btn-warning">Edit</a>
                                        <form action="{{ route('paket_mcu.destroy', $paket->id) }}" method="POST" style="display: inline;">
                                            @csrf
                                            @method('DELETE')
