...
<body>
    <div class="container">
        <h1>Dokter Spesialis Penyakit Dalam</h1>
        <p>Pilih Dokter Spesialis Sesuai Keinginan Anda</p>
        <div class="select-container">
            <select class="form-select">
                <option selected>Penyakit Dalam</option>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="doctor-card">
                    ...
                    <div class="doctor-info">
                        ...
                        <p>Dr. dr.Mariska Diksy Yuniar, Sp.PD</p>
                        <div class="btn-group">
            ...
            <div class="col-md-6">
                <div class="doctor-card">
                    ...
                    <div class="doctor-info">
                        <p class="specialty">Spesialis Penyakit Dalam</p>
                        <p>dr.Nasywa Afifah Wijaya, Sp.PD</p>
                        <div class="btn-group">
                            <button class="btn btn-primary">Janji Temu</button>
                            <button class="btn btn-primary" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                                Lihat Jadwal Dokter
            ...
            <div class="col-md-6">
                <div class="doctor-card">
                    ...
                    <div class="doctor-info">
                        <p class="specialty">Spesialis Penyakit Dalam</p>
                        <p>Dr. dr.Theodora Marshanda Siregar, Sp.PD</p>
                        <div class="btn-group">
                            <button class="btn btn-primary">Janji Temu</button>
                            <button class="btn btn-primary" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                                Lihat Jadwal Dokter
