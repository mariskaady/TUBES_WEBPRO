        ...
        <div class="row">
            <div class="col-md-6">
                <div class="doctor-card">
                    ...
                    <div class="doctor-info">
                        <p class="specialty">Spesialis Paru</p>
                        <p>Dr. dr.Mariska Diksy Yuniar, Sp.P</p>
                        <div class="btn-group">
            ...
            <div class="col-md-6">
                <div class="doctor-card">
                    ...
                    <div class="doctor-info">
                        <p class="specialty">Spesialis Paru</p>
                        <p>dr.Nasywa Afifah Wijaya, Sp.P</p>
                        <div class="btn-group">
                            <button class="btn btn-primary">Janji Temu</button>
                            <button class="btn btn-primary" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                                Lihat Jadwal Dokter
            ...
            <div class="col-md-6">
                <div class="doctor-card">
                    ...
                    <div class="doctor-info">
                        <p class="specialty">Spesialis Paru</p>
                        <p>Dr. dr.Theodora Marshanda Siregar, Sp.P</p>
                        <div class="btn-group">
                            <button class="btn btn-primary">Janji Temu</button>
                            <button class="btn btn-primary" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                                Lihat Jadwal Dokter
            ...
            <div class="col-md-6">
                <div class="doctor-card">
                    ...
                    <div class="doctor-info">
                        <p class="specialty">Spesialis Paru</p>
                        <p>dr.Syarifah Nirmala Eka Putri, Sp.P</p>
                        <div class="btn-group">
                            <button class="btn btn-primary">Janji Temu</button>
                            <button class="btn btn-primary" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                                Lihat Jadwal Dokter
