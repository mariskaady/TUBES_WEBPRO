        ...
        <div class="row">
            <div class="col-md-6">
                <div class="doctor-card">
                    ...
                    <div class="doctor-info">
                        <p class="specialty">Spesialis Umum</p>
                        <p>Dr. dr.Mariska Diksy Yuniar</p>
                        <div class="btn-group">
            ...
            <div class="col-md-6">
                <div class="doctor-card">
                    ...
                    <div class="doctor-info">
                        <p class="specialty">Spesialis Umum</p>
                        <p>Dr. dr.Theodora Marshanda Siregar</p>
                        <div class="btn-group">
                            <button class="btn btn-primary">Janji Temu</button>
                            <button class="btn btn-primary" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                                Lihat Jadwal Dokter
            ...
            <div class="col-md-6">
                <div class="doctor-card">
                    ...
                    <div class="doctor-info">
                        <p class="specialty">Spesialis Umum</p>
                        <p>dr.Syarifah Nirmala Eka Putri</p>
                        <div class="btn-group">
                            <button class="btn btn-primary">Janji Temu</button>
                            <button class="btn btn-primary" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                                Lihat Jadwal Dokter
