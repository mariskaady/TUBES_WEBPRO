...
<body>
    <div class="container">
        <h1>Dokter Spesialis Jantung & Pembuluh Darah</h1>
        <p>Pilih Dokter Spesialis Sesuai Keinginan Anda</p>
        <div class="select-container">
            <select class="form-select">
                <option selected>Jantung & Pembuluh Darah</option>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="doctor-card">
                    <div class="doctor-img-container">
                        <img class="doctor-img" src="images/mariska.jpg" alt="Dr. Eka Airlangga">
                    </div>
                    <div class="doctor-info">
                        <p class="specialty">Spesialis Jantung</p>
                        <p>Dr. dr.Mariska Diksy Yuniar, Sp.JP</p>
                        <div class="btn-group">
            ...
            <div class="col-md-6">
                <div class="doctor-card">
                    <div class="doctor-img-container">
                        <img class="doctor-img" src="images/nasywa.jpg" alt="dr.Muhammad Ali">
                    </div>
                    <div class="doctor-info">
                        <p class="specialty">Spesialis Jantung</p>
            ...
            <div class="col-md-6">
                <div class="doctor-card">
                    <div class="doctor-img-container">
                        <img class="doctor-img" src="images/teo.jpg" alt="Dr. Eka Airlangga">
                    </div>
                    <div class="doctor-info">
                        <p class="specialty">Spesialis Jantung</p>
                        <p>Dr. dr.Theodora Marshanda Siregar, Sp.JP</p>
                        <div class="btn-group">
                            <button class="btn btn-primary">Janji Temu</button>
                            <button class="btn btn-primary" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                                Lihat Jadwal Dokter
            ...
            <div class="col-md-6">
                <div class="doctor-card">
                    <div class="doctor-img-container">
                        <img class="doctor-img" src="images/lala.jpg" alt="dr.Muhammad Ali">
                    </div>
                    <div class="doctor-info">
                        <p class="specialty">Spesialis Jantung</p>
                        <p>dr.Syarifah Nirmala Eka Putri, Sp.JP</p>
                        <div class="btn-group">
                            <button class="btn btn-primary">Janji Temu</button>
                            <button class="btn btn-primary" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                                Lihat Jadwal Dokter
